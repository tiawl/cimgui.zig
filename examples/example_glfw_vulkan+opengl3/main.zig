...
// $ ./zig-out/bin/example_glfw_vulkan+opengl3
// The command line to run it with OpenGL backend:
// $ env USE_GL=true ./zig-out/bin/example_glfw_vulkan+opengl3
...
pub fn main(init: std.process.Init) !void {
    ...
    if (you_choosed_vulkan) {
        ...
        while (c.glfwWindowShouldClose(window) == 0) {
            ...
            if (g_SwapChainRebuild) {
                ...
                if (width > 0 and height > 0) {
                    ...
                    c.cImGui_ImplVulkanH_CreateOrResizeWindow(g_Instance, g_PhysicalDevice, g_Device, &g_MainWindowData, g_QueueFamily.?, g_Allocator, width, height, g_MinImageCount, g_SwapChainImageUsage);
        ...
        std.log.info("I'm using OpenGL3 Renderer backend", .{});
