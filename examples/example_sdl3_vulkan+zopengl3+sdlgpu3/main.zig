...
// $ ./zig-out/bin/example_sdl3_vulkan+zopengl3+sdlgpu3
// The command line to run it with zOpenGL3 backend:
// $ env RENDERER=zOpenGL3 ./zig-out/bin/example_sdl3_vulkan+zopengl3+sdlgpu3
// The command line to run it with SDLGPU3 backend:
// $ env RENDERER=SDLGPU3 ./zig-out/bin/example_sdl3_vulkan+zopengl3+sdlgpu3
